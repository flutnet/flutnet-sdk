...
namespace FlutnetUI.Ext.Controls
{
    ...
    public class HtmlControl : Control
    {
        ...
        public static readonly RoutedEvent ImageLoadEvent = 
            RoutedEvent.Register<HtmlRendererRoutedEventArgs<HtmlImageLoadEventArgs>>("ImageLoad", RoutingStrategies.Bubble, typeof (HtmlControl));
        ...
        */
        ...
        private void RaiseRouted<T>(RoutedEvent ev, T arg)
        {
