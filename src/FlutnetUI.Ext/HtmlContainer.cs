...
namespace FlutnetUI.Ext
{
    ...
    public sealed class HtmlContainer : IDisposable
    {
        ...
        {
            get { return HtmlUtil.Convert(_htmlContainerInt.ScrollOffset); }
            set { _htmlContainerInt.ScrollOffset = HtmlUtil.Convert(value); }
        }
        ...
        {
            get { return HtmlUtil.Convert(_htmlContainerInt.Location); }
            set { _htmlContainerInt.Location = HtmlUtil.Convert(value); }
        }
        ...
        public Size MaxSize
        {
            get { return HtmlUtil.Convert(_htmlContainerInt.MaxSize); }
            set { _htmlContainerInt.MaxSize = HtmlUtil.Convert(value); }
        }
        ...
        {
            get { return HtmlUtil.Convert(_htmlContainerInt.ActualSize); }
            internal set { _htmlContainerInt.ActualSize = HtmlUtil.Convert(value); }
        }
        ...
        {
            return _htmlContainerInt.GetAttributeAt(HtmlUtil.Convert(location), attribute);
        }
        ...
        public List<LinkElementData<Rect>> GetLinks()
        {
            ...
            {
                linkElements.Add(new LinkElementData<Rect>(link.Id, link.Href, HtmlUtil.Convert(link.Rectangle)));
            }
            return linkElements;
        }
        ...
        {
            return _htmlContainerInt.GetLinkAt(HtmlUtil.Convert(location));
        }
        ...
        public Rect? GetElementRectangle(string elementId)
        {
            ...
            return r.HasValue ? HtmlUtil.Convert(r.Value) : (Rect?)null;
        }
        ...
        public void PerformPaint(DrawingContext g, Rect clip)
        {
            ...
            using (var ig = new GraphicsAdapter(g, HtmlUtil.Convert(clip)))
            {
        ...
        public void HandleLeftMouseDown(Control parent, PointerEventArgs e)
        {
            ...
            _htmlContainerInt.HandleMouseDown(new ControlAdapter(parent), HtmlUtil.Convert(e.GetPosition(parent)));
        }
        ...
        public void HandleMouseDoubleClick(Control parent, PointerEventArgs e)
        {
            ...
            _htmlContainerInt.HandleMouseDoubleClick(new ControlAdapter(parent), HtmlUtil.Convert(e.GetPosition(parent)));
        }
        ...
        public void HandleMouseMove(Control parent, Point mousePos)
        {
            ...
            _htmlContainerInt.HandleMouseMove(new ControlAdapter(parent), HtmlUtil.Convert(mousePos));
        }
