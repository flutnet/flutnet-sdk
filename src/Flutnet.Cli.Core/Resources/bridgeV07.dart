...
class Bridge {
  ...
  ///static Future<Map<String, dynamic>> _invokeOnChannelOld({
  ///  @required String instanceId,
  ///  @required String service,
  ///  @required String operation,
  ///  @required Map<String, dynamic> arguments,
  ...
  static Future<Map<String, dynamic>> _invokeOnChannel({
    ...
    String methodName = '$instanceId|null|$service|$operation';
    String jsonRes = await _channel.invokeMethod<String>(
      methodName,
      // Serialize all the args as Json string
      arguments.map((argName, value) => MapEntry(argName, jsonEncode(value))),
    );
  ...
  static _FlutterEvent _mapEvent(dynamic event) {
    try {
      return _FlutterEvent.fromJson((event as Map));
...
class _FlutterDebuggerMessage {
  ...
  static _FlutterDebuggerMessage fromJson(Map<String, dynamic> json) {
    if (json == null) return null;
