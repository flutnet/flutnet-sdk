...
///
/// Emulate flutter_xamarin channel using a websocket.
/// Channel used for DEBUGGING --> websocket conncetion with a backend xamarin form application.
/// Emulate a native call using web socket.
///
class _DebugChannel {
