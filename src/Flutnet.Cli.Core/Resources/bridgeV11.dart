      ...
      () async {
        ...
        if (isAppEmbedded) {
          ...
          completer.completeError(Exception(
            ...
            "If you want to run your Flutter as an EMBEDDED module, set 'FlutnetBridgeConfig.mode = ${FlutnetBridgeMode.PlatformChannel}' "
            "and recompile both Flutter and Xamarin projects.\n"
            "Otherwise run your Flutter project as a STANDALONE application, using your preferred Flutter IDE (like Visual Studio Code).",
          ));
          return;
        }
